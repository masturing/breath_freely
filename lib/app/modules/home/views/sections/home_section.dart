...
class _HomeSectionState extends State<HomeSection> {
  ...
  late Timer _timer;
  late bool _isAqiIndexVisible;
  late TextEditingController _textController;

  @override
  void initState() {
    super.initState();
    _isAqiIndexVisible = true;
  ...
  void _toggleText() {
    setState(() {
      _isAqiIndexVisible = !_isAqiIndexVisible;
    });
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style:
                                CustomTextStyle.bold.copyWith(fontSize: 20.sp),
                          ),
                          0.gH,
                          AnimatedSwitcher(
                            duration: Duration(milliseconds: 500),
                            child: _isAqiIndexVisible
                                ? Column(
